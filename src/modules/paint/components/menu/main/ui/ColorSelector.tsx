...
const ColorSelector = () => {
    ...
    return (
        <label className="relative overflow-hidden rounded-full w-[var(--pm-color-size)] h-[var(--pm-color-size)] mx-[var(--pm-btn-pad)] border-2 flex-shrink-0" style={{ borderColor: 'var(--paint-menu-border-strong)' }}>
